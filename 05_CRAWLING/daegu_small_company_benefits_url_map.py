...
# 1) 파일 읽기
# ---------------------------------------
file_path = "./daegu_small_company_benefits_url_map.text"  # 같은 폴더에 두었을 경우
...
cloud.to_file("daegu_small_company_wordcloud.png")  # 책 모양으로 저장
print("[완료] daegu_small_company_wordcloud.png 저장됨")
